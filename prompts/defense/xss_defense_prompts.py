...
You are given a CLUSTER of similar Cross-Site Scripting (XSS) payloads that currently BYPASS the WAF. {_FAMILIES}

Your task: propose the MINIMUM number of GENERALISED ModSecurity SecRules (ideally 1, at most 3) that block ALL payloads in the cluster, WITHOUT blocking benign traffic.
