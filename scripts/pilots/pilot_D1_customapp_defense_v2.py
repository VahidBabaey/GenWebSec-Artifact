...
from prompts.customapp_defense_prompts import (
...
RESULTS_DIR = Path(__file__).parent.parent / "results" / "V2" / os.environ.get("D1_OUTBASE", "CustomApp_D1") / ("CustomApp_D1" + (f"_eps{CLUSTERING_EPS}" if MODE == "clustering" else "") + (f"_seed{RANDOM_SEED}" if os.environ.get("D1_SEED") else ""))   # item 6: eps-tagged; item 1: seed-tagged; ALL D1 output nested under results/V2/CustomApp_D1/
